...
<body>
    ...
    <form method="post" id="productenqiryfrm" action="send_mail.php">
        ...
        <div class="row">
            ...
            <div class="g-recaptcha" data-sitekey="6LfsUmsgAAAAACWvszVsMmxgiI9oCx0T-VZh8s7g"></div>
      <br/>
            <div class="form-group form-feild-full">
                <button type="submit" value="Submit"  name="submit" class="knowmorebutlink"><span></span><span></span><span></span><span></span>Submit</button>
            </div>
